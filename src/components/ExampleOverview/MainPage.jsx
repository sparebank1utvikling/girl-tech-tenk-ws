...
import { MyErrorMessage } from "../ErrorMessage.jsx";
import { MySpinner } from "../Spinner.jsx";
import { getKontoliste } from "./fetch-helpers.jsx";
  ...
  return (
    <>
      <div>
        ...
        <SecondaryButton onClick={() => hentKontoListe(true)}>
          Kontoliste: ok
        </SecondaryButton>
        <SecondaryButton onClick={() => hentKontoListe(false)}>
          Kontoliste: error
        </SecondaryButton>
        <DividerLine />
      </div>
